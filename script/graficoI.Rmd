...
plot_grid(b, a, nrow = 1, rel_widths = c(.2, 5)) -> main_plot


plot_grid(map, title, nrow = 1, rel_widths = c(0.8, 3)) -> map_title


plot_grid(map_title, c, ncol = 1, rel_heights = c(.35, 4)) -> output_suicide


for(device in c("png", "pdf")){
  ggsave(plot = output_suicide, 
         filename = paste0("suicide_44.", device), path = "C:/Users/tiago/OneDrive/Documentos/aed-projeto.suicidio/output", device = device, 
